'''This module defines an object class called a series that makes it easy to download and manipulate data from the Federal Reserve Economic Database (FRED). FRED is a rich database managed by the Federal Reserve Bank of St Louis. Learn more about FRED:

    http://research.stlouisfed.org/fred2/

An instance of a fred object is initialized with the command:

    fredata.series(series_id)

where series_id is the unique Series ID for the FRED data series that is to be retreived (string format).

Module dependencies: matplotlib, numpy, statsmodels

Created by: Brian C Jenkins. Email comments and suggestions to bcjenkin@uci.edu. Version date: June 22, 2015.
    
For Python 2.76 and 3.4'''
